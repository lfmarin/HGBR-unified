...
export default function RegistroDoctor(){
    ...
    const guardaDoctor = () => {
        axios.post ("https://localhost:5001/hospitalBoca/doctores/save", {
            nombre : datos.Nombre,
        ...
        <Paper elevation={3}>
            <Grid container spacing={1} justifyContent="center">
                <Grid item xs margin={1}>
                    <Typography className={style.line} variant="h5" style={{color: "#AC3833", fontWeight: "bold"}}>Registro de doctor</Typography>
                </Grid>
            </Grid>
            <Grid container spacing={1} justifyContent="center">
                <Grid item xs margin={1}>
