...
{
    public string FkPaciente { get; set; } = null!;

    public int? FkHospital { get; set; }

    public DateOnly? FechaEncuesta { get; set; }

    public DateOnly? FechaVasectomia { get; set; }
    ...
    public DateOnly? FechaNegativo { get; set; }
    ...
    public virtual Paciente FkPacienteNavigation { get; set; } = null!;
}
